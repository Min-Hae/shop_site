...
** 상품 상세보기 **<br>
<%@include file="admin_top.jsp" %> <%--로그인했을 때만 productdetail에 올 수 있음 --%>
...
<form action="productupdate.jsp" name="updateForm" method="post">	<!-- 수정을 위한 form tag. 보일 필요 없으므로 hidden type -->
	<input type="hidden" name="no">
</form>
<form action="productproc.jsp?flag=delete" name="delForm" method="post">	<!--삭제를 위한 form tag. 보일 필요 없으므로 hidden type -->
	<input type="hidden" name="no">
</form>
